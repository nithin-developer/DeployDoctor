"""
Analysis Router - Routes for the AI Repository Analyser
Migrated from working-app/main.py
"""
import os
import json
import uuid
...
from schemas.analysis import AnalysisRequest, AnalysisResult, AnalysisStatus
...
@router.get("/api/analyze/{analysis_id}/status", response_model=AnalysisStatus)
...
@router.get("/api/analyze/{analysis_id}/result")
...
@router.get("/api/analyze/{analysis_id}/report/json")
...
@router.get("/api/analyze/{analysis_id}/report/pdf")
